export declare const ElInputNumber: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    input: import("vue").Ref<import("vue").ComponentPublicInstance<import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
        ...
        select: () => void;
        clear: () => void;
        innerSuffixRef: import("vue").Ref<HTMLElement | undefined>;
        innerPrefixRef: import("vue").Ref<HTMLElement | undefined>;
        inputStyleInner: import("vue").Ref<{
        ...
        getSuffixOrPrefixWidth: (slotElm: import("vue").Ref<HTMLElement>, defaultVal: number) => number;
