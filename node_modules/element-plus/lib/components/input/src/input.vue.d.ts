...
declare const _default: import("vue").DefineComponent<{
    ...
    select: () => void;
    clear: () => void;
    innerSuffixRef: Ref<HTMLElement | undefined>;
    innerPrefixRef: Ref<HTMLElement | undefined>;
    inputStyleInner: Ref<{
    ...
    getSuffixOrPrefixWidth: (slotElm: Ref<HTMLElement>, defaultVal: number) => number;
